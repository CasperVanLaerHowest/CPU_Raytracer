# CPU_Raytracer
This is a CPU Raytracer that started from a school project and has added new optimisations into this project

Start Features:
- Multithreaded Ray Tracer built from scratch in C++.
